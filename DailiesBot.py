...
def findState():
    ...
    if locateOnScreenBool("Images/Battle_Winrate.png", confidence = 0.8, grayscale = True, region = (800,750,1120,200)):#1515 765, 1815 900
        return 5
    if locateOnScreenBool("Images/ConfirmEnd.png", confidence = 0.8, grayscale = True, region = (1515,765,300,135)):#you win
        return 6
    if locateOnScreenBool("Images/Battle_Skill.png", confidence = 0.8, grayscale = True, region = (1172,371,1162,58)):
        return 7
    if locateOnScreenBool("Images/ChargeEnkephalin.png", confidence = 0.8, grayscale = True, region = (740, 146,1172-740,212-146)):
        return 8
    return -1
